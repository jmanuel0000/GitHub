...
using namespace std;
/* Ingresar el nombre, notaa, notae usando procedimientos luego determinar la nota final, y observcion usando procedimiento, presentar
los datos usando otro procedimiento. */
